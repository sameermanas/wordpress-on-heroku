...
class WooSlider_Admin {
	...
	public function admin_styles_global () {
		global $wooslider;
		wp_register_style( $wooslider->token . '-global', $wooslider->plugin_url . 'assets/css/global.css', '', NULL, 'screen' );
	...
	public function add_media_tab ( $tabs ) {
		$tabs['wooslider'] = __( 'Sliders', 'wooslider' );
		return $tabs;
	} // End add_media_tab()
...
<form action="media-new.php" method="post" id="wooslider-insert">
	<?php submit_button( __( 'Insert Slider', 'wooslider' ) ); ?>
