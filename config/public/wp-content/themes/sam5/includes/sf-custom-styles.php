<?php
	...
	*/
	...
	function sf_custom_styles() {
		...
		$google_standard_font = $google_heading_font = $google_font_one = $google_font_one_weight = $google_font_two = $google_font_two_weight = $custom_fonts = "";
		...
		echo 'a:hover, #sidebar a:hover, .pagination-wrap a:hover, .carousel-nav a:hover, .portfolio-pagination div:hover > i, #footer a:hover, #copyright a, .beam-me-up a:hover span, .portfolio-item .portfolio-item-permalink, .read-more-link, .blog-item .read-more, .blog-item-details a, .author-link, .comment-meta .edit-link a, .comment-meta .comment-reply a, #reply-title small a, ul.member-contact, ul.member-contact li a, #respond .form-submit input:hover, span.dropcap2, .wpb_divider.go_to_top a, love-it-wrapper:hover .love-it, .love-it-wrapper:hover span, .love-it-wrapper .loved, .comments-likes a:hover i, .comments-likes .love-it-wrapper:hover a i, .comments-likes a:hover span, .love-it-wrapper:hover a i, .item-link:hover, #header-translation p a, #swift-slider .flex-caption-large h1 a:hover, .wooslider .slide-title a:hover, .caption-details-inner .details span > a, .caption-details-inner .chart span, .caption-details-inner .chart i, #swift-slider .flex-caption-large .chart i, #breadcrumbs a:hover {color: '.$accent_color.';}'. "\n";
		...
		echo '#logo img {padding-top: '.$logo_spacing_top.'px;padding-right: '.$logo_spacing_right.'px;padding-bottom: '.$logo_spacing_bottom.'px;padding-left: '.$logo_spacing_left.'px;}'. "\n";
		if ($logo_width > 0) {
		echo '#logo img, #logo img.retina {max-width: '.$logo_width.'px;}'. "\n";
		}
		...
		echo 'nav .menu > li a, #menubar-controls a, #mini-search a {color: '.$nav_text_color.';}'. "\n";
		...
		echo '#nav-search {background: '.$topbar_bg_color.';}'. "\n";
		echo '#nav-search a {color: '.$topbar_text_color.';}'. "\n";
		echo '#mini-search input {color: '.$topbar_text_color.';}'. "\n";
		...
		echo 'body, h6, #sidebar .widget-heading h3, #header-search input, .header-items h3.phone-number, .related-wrap h4, #comments-list > h4, .item-heading h1, .sf-button, button, input[type="submit"], input[type="reset"], input[type="button"], input[type="email"], .wpb_accordion_section h3, #header-login input, #mobile-navigation > div {font-family: "'.$google_font_one.'", sans-serif;font-weight: '.$google_font_one_weight.';}'. "\n";
		}
		...
		$replace_with = 'body, h6, #sidebar .widget-heading h3, #header-search input, .header-items h3.phone-number, .related-wrap h4, #comments-list > h4, .item-heading h1, .sf-button, button, input[type="submit"], input[type="reset"], input[type="button"], input[type="email"], .wpb_accordion_section h3, #header-login input, #mobile-navigation > div {';
