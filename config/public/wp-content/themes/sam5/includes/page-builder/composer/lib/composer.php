    ...
    public function deleteTemplateJavascript_callback() {
     ...
     public function loadSFTemplateJavascript_callback() {
		...
		if ($template_id == "sf-home") {
		    ...
		    <p style="text-align: center;">sam5 is completely responsive. And when we say responsive, we mean it won’t only work on mobile devices; it’ll look damn good too!</p>
		    ...
		    <p style="text-align: center;">sam5 includes pro Font Deck support. Or you can choose from 600+ Google Web fonts &amp; control the colour, size &amp; line height.</p>
		    <p style="text-align: center;"><a class="read-more" href="#">Find out more <i class="icon-chevron-right">&gt;</i></a></p>
		    ...
		    <p style="text-align: center;">sam5 comes with 3 sliders included. The ever popular Revolution Slider, Woo Slider and our own innovative and stunning Swift Slider.</p>
		    <p style="text-align: center;"><a class="read-more" href="#">Find out more <i class="icon-chevron-right">&gt;</i></a></p>
		    ...
		    <h2>sam5: A responsive, retina-ready &amp; wide multipurpose Word Press theme.</h2>
			...
			$content = '[fullwidth_text title="Welcome to sam5" alt_background="alt-seven" el_class="mb0 mt0 bb0 bt0 no-arrow" width="1/1" el_position="first last"]
			<h1 style="text-align: center;">sam5 is a sleek, wide &amp; incredibly responsive multi-purpose WordPress theme. It is fully translatable, has built WooCommerce support, 14 prebuilt pages, 12 Blog Options, 7 Portfolio Options, 5 Headers + more. It has everything you need to build something exceptional.</h1>
			...
			Email: <a href="http://themes.swiftpsd.com/test/sam5/contact/#" target="_blank">youremail@yourdomain.com
			...
			<h2>Hi, I&#39;m sam5. A responsive, flexible &amp; minimal multipurpose Word Press theme.</h2>
			...
			sam5 is completely responsive. And when we say responsive, we mean it won’t only work on mobile devices; it’ll look damn good too!
			...
			sam5 includes pro Font Deck support. Or you can choose from 600+ Google Web fonts &amp; control the colour, size &amp; line height.
			...
			sam5 comes with 3 sliders included. The ever popular Revolution Slider, Woo Slider and our own innovative and stunning Swift Slider.
			...
			[/vc_column_text] [blank_spacer height="36px" width="1/1" el_position="first last"] [portfolio_carousel title="Recent Projects" item_count="5" category="all" alt_background="alt-one" el_class="mt0 mb0 bb0" width="1/1" el_position="first last"] [testimonial_slider title="Testimonials" text_size="large" item_count="6" order="date" category="all" animation="slide" autoplay="no" alt_background="alt-four" el_class="mt0 bt0" width="1/1" el_position="first last"] [blank_spacer height="20px" width="1/1" el_position="first last"] [recent_posts title="Latest From Our Blog" item_count="4" category="all" excerpt_length="16" width="1/1" el_position="first last"] [blank_spacer height="31px" width="1/1" el_position="first last"]';	
	 		...
	 		<span style="text-align: center;"><img class="size-full wp-image-6534 aligncenter" alt="f_about_logo2" src="http://themes.swiftpsd.com/test/sam5/wp-content/uploads/2013/01/f_about_logo2.png" width="100" height="100" /></span>
        	...
        	[one_fourth]<img class="alignnone size-full wp-image-6756" alt="ff_team4_retina_bw" src="http://themes.swiftpsd.com/test/sam5/wp-content/uploads/2013/03/ff_team4_retina_bw.jpg" width="540" height="540" />
        	...
        	[one_fourth]<img class="alignnone size-full wp-image-6615" alt="ff_team1_retina_bw" src="http://themes.swiftpsd.com/test/sam5/wp-content/uploads/2013/03/ff_team1_retina_bw.jpg" width="540" height="540" />
        	...
        	[one_fourth]<img class="alignnone size-full wp-image-6616" alt="team2_retina_bw" src="http://themes.swiftpsd.com/test/sam5/wp-content/uploads/2013/03/team2_retina_bw.jpg" width="540" height="540" />
        	...
        	[one_fourth]<img class="alignnone size-full wp-image-6614" alt="ff_team3_retina_bw" src="http://themes.swiftpsd.com/test/sam5/wp-content/uploads/2012/11/ff_team3_retina_bw.jpg" width="540" height="540" />
