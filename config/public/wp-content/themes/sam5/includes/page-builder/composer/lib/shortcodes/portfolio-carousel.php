...
class WPBakeryShortCode_portfolio_carousel extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
		    ...
		    $title = $category = $item_class = $width = $exclude_categories = $el_class = $output = $filter = $items = $el_position = '';
...
WPBMap::map( 'portfolio_carousel', array(
    ...
    "params"	=> array(
        ...
        array(
            ...
            "value" => "",
            "description" => __('If you would like to exclude categories from the portfolio items, then enter the portfolio category IDs here, seperated by a comma and a space, e.g. "1, 7, 23".', "js_composer")
        ),
        array(
            "type" => "dropdown",
            ...
            "description" => __("Show an alternative background around the asset. These can all be set in sam5 Options > Asset Background Options. NOTE: This is only available on a page with the no sidebar setup.", "js_composer")
        ),
        array(
            "type" => "altbg_preview",
