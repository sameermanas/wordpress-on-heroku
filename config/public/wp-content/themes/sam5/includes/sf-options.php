...
function setup_framework_options(){
    ...
    // Default: Options
    $args['menu_title'] = __('sam5 Options', Redux_TEXT_DOMAIN);

    // Set a custom page title for the options page.
    // Default: Options
    $args['page_title'] = __('sam5 Theme Options', Redux_TEXT_DOMAIN);
    ...
    $sections[] = array(
    				...
    				'fields' => array(
    					...
    					array(
    						...
    						'desc' => '',
    						'std' => "&copy;[the-year] sam5 &middot; Built by <a href='http://www.swiftpsd.com'>Swift Ideas</a> &middot; Powered by [wp-link]"
    						),
    					array(
    						'id' => 'show_backlink',
    						'type' => 'button_set',
    ...
    $sections[] = array(
    				...
    				'fields' => array(
    					...
    					array(
    						...
    						'sub_desc' => __('Paste the css here that can be found from step 2 of the FontDeck instructions (<a href="http://themes.swiftpsd.com/shared/sam5/fontdeck_step2.png" class="view" target="_blank">view</a>). NOTE: Make sure you provide the JS code in the box at the bottom for this/all FontDeck fonts you want to use.', Redux_TEXT_DOMAIN),
    						'desc' => '',
    						'std' => ''
    						),
    					array(
    					...
    					array(
    						...
    						'sub_desc' => __('Paste the js code here that can be found from step 1 of the FontDeck instructions (<a href="http://themes.swiftpsd.com/shared/sam5/fontdeck_step1.png" class="view" target="_blank">view</a>).', Redux_TEXT_DOMAIN),
    						'desc' => '',
    						'std' => ''
    						),
    					)
    ...
    $tabs['documentation'] = array(
    				...
    				'content' => '<p>Documentation for sam5 is available here <a href="http://themes.swiftpsd.com/documentation/sam5" target="_blank">here</a>.</p>'
    				);
    ...
    $tabs['support'] = array(
    				...
    				'content' => '<p>If you need support for sam5, please visit our support site <a href="http://support.swiftpsd.com" target="_blank">here</a>.</p>'
    				);				
    ...
    $tabs['translation_plugin'] = array(
    				...
    				'content' => '<p>sam5 is 100% translation and multi-lingual ready, and we recommend that you use the very popular WPML plugin.</p>
    				...
    				<ol>
    					<li>Open the /sam5/languages/ folder and duplicate the en_US.po file, then rename it to your desired language code. For example; for German you need to re-name it as de_DE.po for Spanish es_ES.po for Turkish tr_TR.po etc. You can find all the codes from this link <a href="http://codex.wordpress.org/WordPress_in_Your_Language" target="_blank">http://codex.wordpress.org/WordPress_in_Your_Language</a></li>
