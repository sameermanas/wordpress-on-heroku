<?php
			...
			<?php
				$swiftideas_backlink = "";
				if ($show_backlink) {			
				$swiftideas_backlink =	apply_filters("swiftideas_link", " &middot; <a href='http://www.96down.com'>Downloaded from 96down.com</a>");
				}
		...
		<?php
			...
			global $has_portfolio, $has_blog, $include_maps, $include_isotope, $include_carousel, $has_progress_bar, $has_chart;
