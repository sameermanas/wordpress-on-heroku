<?php
	...
	function sf_enqueue_scripts() {
	    ...
	    wp_register_script('sf-styleswitcher-js', get_template_directory_uri() . '/includes/styleswitcher/styleswitcher.js', 'jquery', NULL, TRUE);
	...
	*	WooCommerce Functions		       	     	* 
	...
	function language_flags(){
		if (function_exists('icl_get_languages')) {
	    	...
	    	echo '<li><a href="#">DEMO - EXAMPLE PURPOSES</a><li><a href="#"><img src="http://themes.swiftpsd.com/test/flexform/wp-content/plugins/sitepress-multilingual-cms/res/flags/de.png" height="12" alt="de" width="18"><span class="language name">German</span></a></li><li><div class="current-language"><img src="http://themes.swiftpsd.com/test/flexform/wp-content/plugins/sitepress-multilingual-cms/res/flags/en.png" height="12" alt="en" width="18"><span class="language name">English</span></div></li><li><a href="#"><img src="http://themes.swiftpsd.com/test/flexform/wp-content/plugins/sitepress-multilingual-cms/res/flags/es.png" height="12" alt="es" width="18"><span class="language name">Spanish</span></a></li><li><a href="#"><img src="http://themes.swiftpsd.com/test/flexform/wp-content/plugins/sitepress-multilingual-cms/res/flags/fr.png" height="12" alt="fr" width="18"><span class="language name">French</span></a></li>'."\n";
	    }
	}
